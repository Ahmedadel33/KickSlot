  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data && res.data.token) {
        ...
        navigate("/"); 
        console.error("Token missing from response. Keys received:", Object.keys(res.data));
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {error && (
              <div className={styles.errorBox} style={{ marginTop: "15px", backgroundColor: "#ffdddd", padding: "10px", borderRadius: "5px" }}>
                <p className={styles.errorMsg} style={{ color: "#cc0000", margin: 0, fontSize: "14px" }}>⚠ {error}</p>
              </div>
            )}
          </form>
